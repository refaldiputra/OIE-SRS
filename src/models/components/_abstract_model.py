...
from models.components._modules import LayerNorm
from torch.nn.init import xavier_uniform_


## this has been modified to accommodate the Hydra configuration.

class SequentialRecModel(nn.Module):
    def __init__(self,
                 item_size: int, # this needs to be calculated based on the data set that is used. item_size  = max_item + 1
                 hidden_size: int,
                 max_seq_length: int,
    ...
    def add_position_embedding(self, sequence):
        # need to be called after the component is initialized
